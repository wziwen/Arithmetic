...
public class CommonRecogParams {
     ...
     * 字符串格式的参数
     */
    protected static ArrayList<String> stringParams = new ArrayList<String>();

    /**
     * int格式的参数
     */
    protected static ArrayList<String> intParams = new ArrayList<String>();

    /**
     * bool格式的参数
     */
    protected static ArrayList<String> boolParams = new ArrayList<String>();
